...
export default class HotelAdicionar extends Component {
    static navigationOptions = {
        title: 'Quidio Turistico',
    };
    constructor() {
        super();
        this.refFireBase = Firebase.firestore().collection('hoteles');
        this.state = {
            nombre: '',
            direccion: '',
            sitioweb: '',
        ...
        return (
            <Container>
                <Content>
                    ...
                    <H1 style={{ textAlign: "center" }}>Adicionar Hotel</H1>
